...
2. If this repo has project-specific conventions (check for a backend/frontend skill, app-level AGENTS.md, or root AGENTS.md), read them first and hold the diff to those standards in addition to general best practices.
